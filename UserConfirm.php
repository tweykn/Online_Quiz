            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  <li class="parent"><a href="Home.php"><i class="icon mdi mdi-layers"></i><span>Home</span></a>
                  </li>
                  <li class="active"><a href="UserConfirm.php"><i class="icon mdi mdi-layers"></i><span>User Confirm</span></a>
                  </li>
                </ul>
              </div>
            </div>
...
<?php
                        ...
                        $sql = "SELECT * FROM users where inConfirm = 0";

                        foreach ($pdo->query($sql) as $dpts) {
                          $typestr = ($dpts["UserType"] == 0 ? 'Profesor': 'Student');
 ?>
 <tr class='odd gradeX'>

 <td><?php echo $dpts['user'];?></td>
 <td><?php echo $dpts['email'];?></td>
 <td><?php echo $dpts['pass'];?></td>
<td><?php echo $typestr ?></td>
<td><button class="btn btn-space btn-success" onclick="Confirm_Click(<?php echo $dpts['uid'];?>,'<?php echo $dpts['email'] ?>');"><i class="icon icon-left mdi mdi-check"></i> Confirm</button></td>
</tr>
...
function Confirm_Click(id, mail) {

  $.ajax({
  type : 'POST',
  url : 'UserConfirmMethod.php',
  data : {
    id : id,
              },
  ...
  data : {
    ...
    title : 'Confirm',
    subject : 'Confirm',
    message : 'You can enter the system.',
              },
  success : function(response){
