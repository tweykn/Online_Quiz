      ...
      <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
          ...
          <div class="be-right-navbar">
            ...
            <div class="page-title"><span> Welcome Your Home Page </div>

          </div>
        </div>
      </nav>
      <div class="be-left-sidebar">
        <div class="left-sidebar-wrapper active"><a href="#" class="left-sidebar-toggle">Home</a>
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default">
                <div class="panel-heading panel-heading-divider">Online Quiz Panel<span class="panel-subtitle">This is the homepage of the portal.</span></div>
                <div class="panel-body">
                  <img src="./assets/_tmp/abu.jpeg" alt="" width="90%">
              </div>
            </div>
          </div>
      </div>
