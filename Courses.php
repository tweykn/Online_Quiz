...
<li class="parent"><a href="#"><i class="icon mdi mdi-chart-donut"></i><span>Confirmation</span></a>
  <ul class="sub-menu">
    <li><a href="confirmation.html">Lecture 1</a>
    </li>
    <li><a href="#">Lecture 2</a>
    </li>
    <li><a href="#">Lecture 3</a>
    </li>
    <li><a href="#">Lecture 4</a>
    </li>
  </ul>
...
<div class="col-sm-12">
              <div class="panel panel-default">
                <div class="panel-heading panel-heading-divider">Select Your Courses  <span class="panel-subtitle"></span></div>
        ...
        <button class="btn btn-space btn-primary btn-lg" style="float:right;" onclick='Apply_Click();'>Apply</button>
        </div>
...
function Apply_Click() {
  var SelectLesson = $('#SearchTypeID').val();

  $.ajax({
  type : 'POST',
  url : 'CoursesMethod.php',
  data : {
SelectLesson:SelectLesson
              },
  success : function(response){
  if(response=="Ok"){
    $("#error").html('<div class="alert alert-success"> <span class="glyphicon glyphicon-info-sign"></span>   '+response+'<br/></div>');
